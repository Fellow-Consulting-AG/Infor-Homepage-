...
define(["require", "exports", "@angular/core", "@angular/common", "@infor/sohoxi-angular", "@angular/forms", "lime", "./assets", "@angular/platform-browser"], function (require, exports, core_1, common_1, sohoxi_angular_1, forms_1, lime_1, assets_1, platform_browser_1) {
    ...
    var PDFComponent = /** @class */ (function () {
        ...
        PDFComponent.prototype.ngOnInit = function () {
            this.sortIcon = this.ds.bypassSecurityTrustUrl(assets_1.assets.sortIcon);
            this.changeDetectionRef.markForCheck();
            this.topMenuItems = [
                { icon: this.ds.bypassSecurityTrustUrl(assets_1.assets.eithernet), label: 'AKTUALISIEREN ' },
                { icon: this.ds.bypassSecurityTrustUrl(assets_1.assets.language), label: 'WEITERLEITEN ' },
                { icon: this.ds.bypassSecurityTrustUrl(assets_1.assets.mediation), label: 'TRENNEN' },
                // {icon: this.ds.bypassSecurityTrustUrl(assets.print), label: 'SORTIEREN'},
                { icon: this.ds.bypassSecurityTrustUrl(assets_1.assets.refresh), label: 'BEARBEITEN' },
                // {icon: this.ds.bypassSecurityTrustUrl(assets.rounded_corner), label: 'FUNKTIONEN'},
                { icon: this.ds.bypassSecurityTrustUrl(assets_1.assets.sort), label: 'EAKTE' },
                { icon: this.ds.bypassSecurityTrustUrl(assets_1.assets.table_view), label: 'HWS/CXS' },
            ];
            this.checkMark = this.ds.bypassSecurityTrustUrl(assets_1.assets.check);
            this.pdfIcon = this.ds.bypassSecurityTrustUrl(assets_1.assets.pdfIcon);
